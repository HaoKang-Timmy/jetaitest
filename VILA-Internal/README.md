# VILA: Efficient Frontier Visual Language Models
...
Cosmos Nemotron training contains three steps. Before running the training scripts, please prepare your training data following the instructions [here](https://github.com/Efficient-Large-Model/VILA-Internal/blob/main/finetuning/README.md). If you would like to reproduce the performance of NVILA, the data used to train NVILA can be found in Appendix of the [paper](https://arxiv.org/abs/2412.04468). After preparing the data, you are able to train NVILA following the several training steps below.
...
### Step-1.5: Vision Encoder Pretraining
...
This is the last stage of Cosmos Nemotron training.
