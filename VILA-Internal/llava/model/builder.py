...
def load_pretrained_model(
    ...
    **kwargs,
    ...
    # NOTE: since tranformers 4.50, device_map will auto TP the model and leads to unexpected errors.
    ...
    # TODO: this may not work for large models which require > 2GPUs to run
    model.eval().cuda()
