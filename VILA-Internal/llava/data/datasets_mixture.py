...
def register_datasets_mixtures():
    ...
    longvila_sft_dataset = Dataset(
        dataset_name="longvila_sft_dataset",
        dataset_type="torch",
        data_path="/lustre/fsw/portfolios/nvr/projects/nvr_elm_llm/dataset/longvideo_sft/longvila_sft_dataset.json",
        image_path="/lustre/fsw/portfolios/nvr/projects/nvr_elm_llm/dataset/shot2story/Shot2Story/data/videos",
    )
    add_dataset(longvila_sft_dataset)
    ...
    # TODO: deprecated, will remove after May 1 2025.
    # TODO: switch mmc4 to wds impl as well.
    ...
    cambrian_doc_1275k = Dataset(
        ...
        dataset_type="torch",
        data_path="/lustre/fsw/portfolios/nvr/users/haotiant/dataset/vila_data/cambrian/cambrian_doc_1275k.json",
        image_path="/home/yunhaof/workspace/datasets/Cambrian/data",
    )
    ...
    coyo_25m_wds_spatial_ocr_bbox_interleaved_qas_30 = Dataset(
        dataset_name="coyo_25m_wds_spatial_ocr_bbox_interleaved_qas_30",
        dataset_type="coyo-wds-qas",
        data_path="/lustre/fsw/portfolios/nvr/projects/nvr_elm_llm/dataset/vila-pretrain/coyo-25m-vila",
        meta_path="/lustre/fsw/portfolios/nvr/projects/nvr_elm_llm/dataset/vila-pretrain/coyo-25m-vila/wids-meta-30-subset.json",
        # Full VILA^2 coyo data: meta_path="/lustre/fsw/portfolios/nvr/projects/nvr_elm_llm/dataset/coyo-25m-vila/wids-meta.json",
        caption_choice="/home/yunhaof/workspace/datasets/data_synthesis/arxiv/compound/coyo_spatial_specialist_clean+/home/yunhaof/workspace/datasets/data_synthesis/arxiv/compound/coyo_ocr_specialist_clean+/home/yunhaof/workspace/datasets/data_synthesis/arxiv/compound/coyo_bbox_interleaved_clean",
        description="30% subset of coyo_25m_wds.",
    )
    add_dataset(coyo_25m_wds_spatial_ocr_bbox_interleaved_qas_30)
